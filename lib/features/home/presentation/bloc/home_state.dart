...
class HomeLoaded extends HomeState {
  ...
  final List<Map<String, dynamic>> data7;
  final List<Map<String, dynamic>> data8;
  final Property? selectedProperty;

  const HomeLoaded(this.data, this.data2, this.data3, this.data4, this.data5,
      this.data6, this.data7, this.data8,
      {this.selectedProperty});

  @override
  List<Object?> get props =>
      [data, data2, data3, data4, data5, data6, data7, selectedProperty];
  ...
  List<UnitTenancy> get unitTenancies =>
      data5.map((e) => UnitTenancy.fromJson(e)).toList();
  ...
  List<ActivityEvent> get activityEvents =>
      data8.map((e) => ActivityEvent.fromJson(e)).toList();
}
